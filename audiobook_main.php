...
<a href="/download/<?php echo str_replace(" ", "-", $coll_title);?>" target="_blank" class="btn btn-raised btn-danger"><i class="fa fa-download"></i> Download Books & Audio</a>
<a href="/readonline/<?php echo $link_id;?>/<?php echo $nama_url;?>" target="_blank" class="btn btn-raised btn-primary"><i class="fa fa-book"></i> Read & Listen Online</a>
<?php endif; ?>
